...
ge.to_csv(x_data_dir/'cancer_gene_expression.tsv', header=False, index=False, sep='\t', line_terminator='\r\n')
ge = None
print("Saved cancer_gene_expression")
...
cn.to_csv(x_data_dir/'cancer_copy_number.tsv', header=False, index=False, sep='\t', line_terminator='\r\n')
cn = None
print("Saved cancer_copy_number")
...
#           line_terminator='\r\n')
discretized_cn.to_csv(x_data_dir/'cancer_discretized_copy_number.tsv', header=False, index=False, sep='\t',
          line_terminator='\r\n')
discretized_cn = None
print("Saved cancer_discretized_copy_number")
...
#           line_terminator='\r\n')
me.to_csv(x_data_dir/'cancer_DNA_methylation.tsv', header=False, index=False, sep='\t',
          line_terminator='\r\n')
me = None
print("Saved cancer_DNA_methylation")
...
#           line_terminator='\r\n')
miRNA.to_csv(x_data_dir/'cancer_miRNA_expression.tsv', header=True, index=True, sep='\t',
          line_terminator='\r\n')
miRNA = None
print("Saved cancer_miRNA_expression")
...
#           line_terminator='\r\n')
rppa.to_csv(x_data_dir/'cancer_RPPA.tsv', header=True, index=True, sep='\t',
          line_terminator='\r\n')
rppa = None
print("Saved cancer_RPPA")
...
#           line_terminator='\r\n')
mu_count.to_csv(x_data_dir/'cancer_mutation_count.tsv', header=False, index=False, sep='\t',
          line_terminator='\r\n')
mu_count = None
print("Saved cancer_mutation_count")
...
#                line_terminator='\r\n')
mu_long.to_csv(x_data_dir/'cancer_mutation_long_format.tsv', header=True, index=False, sep='\t',
               line_terminator='\r\n')
print("Saved cancer_mutation_long_format")


print("\nFinished generating omics data.")
